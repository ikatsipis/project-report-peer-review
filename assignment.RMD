Practical Machine Learning - perr review
==========================================================

For the need of this assignment we wneel to analyze data determine what activity an individual perform.
In order to do this this we have  made use of caret and randomForest, this allowed me to generate correct answers for
...
Firstly, we loaded the data both from the provided training and test data provided by COURSERA.
...
later, we also casted all columns 8 to the end to be numeric.
...
We will perform  5 random forests with 150 trees each. We make use of parallel processing to build this
